"""Tests for Rika Firenet Custom api."""
import asyncio

import aiohttp
from custom_components.rika_firenet_custom.api import (
    RikaFirenetCustomApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = RikaFirenetCustomApiClient("test", "test", async_get_clientsession(hass))
